...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzoone}{Hornyák Máté Dániel}
\newcommand{\vikszerzotwo}{Molnár Marcell}
\newcommand{\vikszerzothr}{Poleczki Ákos}
\newcommand{\vikkonzulens}{dr.~Kiss Bálint}
\newcommand{\kulsokonzulens}{Luspay Tamás Gábor}
\newcommand{\vikcim}{Házi Feladat}
\newcommand{\viktanszek}{Méréstechnika és Információs Rendszerek Tanszék}
\newcommand{\vikdoktipus}{Beágyazott rendszerek szoftvertechnológiája}
%\newcommand{\vikdepartmentr}{Molnár Marcell}
